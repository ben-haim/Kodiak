...
public class Psx50Normalizer implements IMdNormalizer
{
	private static final Logger LOGGER = Logger.getLogger(Psx50Normalizer.class.getName());
	...
	public Psx50Normalizer(Map<MdServiceType, IMdLibraryCallback> callbacks, String range, int channel)
	{
