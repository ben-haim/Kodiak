...
public class Nasdaq50Normalizer implements IMdNormalizer
{
	private static final Logger LOGGER = Logger.getLogger(Nasdaq50Normalizer.class.getName());
	...
	public Nasdaq50Normalizer(Map<MdServiceType, IMdLibraryCallback> callbacks, String range, int channel)
	{
	...
	public void processMessage(String processorName, MdFeedPacket packet, boolean shouldIgnore)
	{
		...
		else if (messageType == ORDER_EXECUTED)
		{
			...
			ByteBufferUtil.advancePosition(buffer, 8); // Match Number
