...
public class BxNormalizer implements IMdNormalizer
{
	...
	public BxNormalizer(Map<MdServiceType, IMdLibraryCallback> callbacks, String range, IMulticastAdapter multicastAdapter)
	{
		this.bookCache = new BookQuoteCache((IMdBookQuoteListener) callbacks.get(MdServiceType.BOOK_XBOS), MdFeed.BX, MdServiceType.BOOK_XBOS, range, multicastAdapter);
	...
	public void processMessage(String processorName, MdFeedPacket packet, boolean shouldIgnore)
	{
		...
		else if (messageType == NOII)
		{
			...
			this.imbalanceCache.updateImbalance(symbol, pairedShares, imbalanceShares, imbalanceSide, 0, currentReferencePrice, nearPrice, farPrice, 0,
					Exchange.USEQ_NASDAQ_OMX_BX, auctionType, timestamp);
		}
