...
public class Bx50Normalizer implements IMdNormalizer
{
	private static final Logger LOGGER = Logger.getLogger(Bx50Normalizer.class.getName());
	...
	public Bx50Normalizer(Map<MdServiceType, IMdLibraryCallback> callbacks, String range, int channel)
	{
